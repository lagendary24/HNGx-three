  ...
  return (
    <section className="flex justify-center w-full h-screen">
      <section className="lg:flex bg-sky-950 flex-col items-center justify-center hidden w-2/3">
        {/* Dropdown animation */}
        <div className="text-blue-500 text-5xl transform translate-y-0 opacity-100 transition-transform ease-in-out duration-12000 delay-500">
  		Welcome To!
		</div>

        <h1 className="bg-inherit text-[#9520b2] text-6xl font-semibold">
          Amazing Images
        </h1>
      </section>
