...
const Header = () => {
  ...
  return (
    <header className="md:w-full md:flex-row md:static sticky top-0 z-50 flex flex-row-reverse items-center justify-between w-full h-16 px-4 text-white bg-red-800">
      <div className="md:hidden w-[10%]"></div>
      <Link
        to="/"
        className="w-[40%] md:w-[20%] flex items-center  md:justify-end gap-2 md:gap-4"
      >
        <span className="md:h-12 md:w-12 flex items-center justify-center w-10 h-10 text-2xl text-green rounded-full">
          <FontAwesomeIcon icon={faImages} />
        </span>
        <span className="text-2xl">Amazing Images</span>
      </Link>
